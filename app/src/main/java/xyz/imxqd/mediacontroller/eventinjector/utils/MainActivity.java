package xyz.imxqd.mediacontroller.eventinjector.utils;
...
import xyz.imxqd.mediacontroller.eventinjector.Events;
import xyz.imxqd.mediacontroller.utils.Shell;
...
public class MainActivity extends Activity implements OnClickListener, OnItemSelectedListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Shell.setShellSU("su");
        System.out.println(Shell.runCommand("ls -l /dev/input/"));
