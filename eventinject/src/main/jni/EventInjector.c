...
Java_xyz_imxqd_injector_Events_intEnableDebug(JNIEnv *env, jclass type, jint enable) {
...
Java_xyz_imxqd_injector_Events_intSendEvent(JNIEnv *env, jclass jtype, jint devid, jint type,
...
JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_ScanFiles(JNIEnv *env, jclass type) {
...
Java_xyz_imxqd_injector_Events_getDevPath(JNIEnv *env, jclass type, jint index) {
    return (*env)->NewStringUTF(env, pDevs[index].device_path);
}


JNIEXPORT jstring JNICALL
Java_xyz_imxqd_injector_Events_getDevName(JNIEnv *env, jclass type, jint index) {
    if (pDevs[index].device_name == NULL) return NULL;
    else return (*env)->NewStringUTF(env, "Test");
}


JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_OpenDev(JNIEnv *env, jclass type, jint index) {
    return open_device(index);
}


JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_RemoveDev(JNIEnv *env, jclass type, jint index) {
    return remove_device(index);
}


JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_PollDev(JNIEnv *env, jclass type, jint index) {
...
JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_getType(JNIEnv *env, jclass type) {
    return event.type;
}


JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_getCode(JNIEnv *env, jclass type) {
    return event.code;
}


JNIEXPORT jint JNICALL
Java_xyz_imxqd_injector_Events_getValue(JNIEnv *env, jclass type) {
    return event.value;
}
